...
[Turning stubs into tests](howto-after-generation.md).

When the specification changes: [Re-syncing after the specification changed](howto-resync.md) — and read
[The contract of generated code](concepts-generated-contract.md) first, because it decides which of your files survive.
